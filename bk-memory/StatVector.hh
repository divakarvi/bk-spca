...
public:
  ...
  void print(ofstream& ofile, const char* banner = ""){
    ofile<<banner<<endl;
    ofile<<setw(10)<<"median: "<<this->median()<<endl;
    ofile<<setw(10)<<"max: "<<this->max()<<endl;
    ofile<<setw(10)<<"mean: "<<this->mean()<<endl;
    ofile<<setw(10)<<"min: "<<this->min()<<endl;
  }
};
