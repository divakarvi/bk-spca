...
# -- End  _Z13multxmm4x1x4RPdS_S_lll
	.text
# -- Begin  _Z15multxmm4x1x4RU2PdS_S_lll
# mark_begin;
       .align    16,0x90
	.globl _Z15multxmm4x1x4RU2PdS_S_lll
_Z15multxmm4x1x4RU2PdS_S_lll:
# parameter 1: %rdi
# parameter 2: %rsi
# parameter 3: %rdx
# parameter 4: %rcx
...
# parameter 6: %r9
..B3.1:                         # Preds ..B3.0
..___tag_value__Z15multxmm4x1x4RU2PdS_S_lll.7:                  #146.46
        movq      %r9, %r8                                      #149.3
        movaps    (%rdx), %xmm0                                 #148.0
        lea       (%r9,%r9,2), %rcx                             #151.3
        shlq      $4, %r8                                       #149.3
        xorl      %eax, %eax                                    #156.17
        movaps    (%r8,%rdx), %xmm2                             #149.0
        movaps    (%rdx,%r9,8), %xmm1                           #150.0
        movaps    (%rdx,%rcx,8), %xmm3                          #151.0
        movaps    16(%rdx), %xmm4                               #152.0
        movaps    16(%rdx,%r8), %xmm6                           #153.0
...
..B3.3:                         # Preds ..B3.2
        ...
        movaps    %xmm6, (%r8,%rdx)                             #220.0
        movaps    %xmm7, (%rdx,%rcx,8)                          #221.0
        movaps    %xmm8, 16(%rdx)                               #222.0
        movaps    %xmm9, 16(%rdx,%r9,8)                         #223.0
        movaps    %xmm10, 16(%rdx,%r8)                          #224.0
        movaps    %xmm11, 16(%rdx,%rcx,8)                       #225.0
        ret                                                     #226.1
        .align    16,0x90
..___tag_value__Z15multxmm4x1x4RU2PdS_S_lll.9:                  #
                                # LOE
# mark_end;
	.type	_Z15multxmm4x1x4RU2PdS_S_lll,@function
	.size	_Z15multxmm4x1x4RU2PdS_S_lll,.-_Z15multxmm4x1x4RU2PdS_S_lll
	.data
# -- End  _Z15multxmm4x1x4RU2PdS_S_lll
	.text
...
.eh_frame_seg:
	...
	.4byte 0x0000001c
	.4byte 0x00000064
	.8byte ..___tag_value__Z15multxmm4x1x4RU2PdS_S_lll.7
	.8byte ..___tag_value__Z15multxmm4x1x4RU2PdS_S_lll.9-..___tag_value__Z15multxmm4x1x4RU2PdS_S_lll.7
	.8byte 0x0000000000000000
	.4byte 0x0000001c
	.4byte 0x00000084
