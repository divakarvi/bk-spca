...
int main(){
  ...
  for(int i=0; i < count; i++){
    ...
    cout.width(45);
    cout<<"Global memory in GB: "<<prop.totalGlobalMem*1.0/1000/1000/1000<<endl;
    cout.width(45);
    ...
    cout.width(45);
    cout<<"Maximum of each dimension of block: "<<prop.maxThreadsDim[0]<<" x "<<
      prop.maxThreadsDim[1]<<" x "<<prop.maxThreadsDim[2]<<endl;
    cout.width(45);
    cout<<"Maximum of each dimension of grid: "<<prop.maxGridSize[0]<<" x "<<
