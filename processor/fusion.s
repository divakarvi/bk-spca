...
..B1.5:                         # Preds ..B1.4
        xorl      %eax, %eax                                    #28.3
        movl      24(%rsp), %ecx                                #28.13
        pxor      %xmm0, %xmm0                                  #28.3
        movsd     (%rsp), %xmm2                                 #28.10
        xorl      %edx, %edx                                    #28.3
        movsd     %xmm0, 16(%rsp)                               #28.3
        testl     %ecx, %ecx                                    #28.3
        movsd     %xmm0, 8(%rsp)                                #28.3
        movsd     .L_2il0floatpacket.56(%rip), %xmm1            #28.3
        jle       ..B1.9        # Prob 10%                      #28.3
                                # LOE rbx r12 r14 r15 eax edx ecx xmm1 xmm2
..B1.6:                         # Preds ..B1.5
        movaps    %xmm2, %xmm0                                  #28.3
        mulsd     %xmm2, %xmm0                                  #28.3
        movsd     8(%rsp), %xmm7                                #28.3
        .align    16,0x90
                                # LOE rbx r12 r14 r15 eax edx ecx xmm0 xmm1 xmm2 xmm7
..B1.7:                         # Preds ..B1.7 ..B1.6
        pxor      %xmm4, %xmm4                                  #28.3
        addsd     %xmm1, %xmm7                                  #28.3
        cvtsi2sd  %eax, %xmm4                                   #28.3
        movsd     .L_2il0floatpacket.54(%rip), %xmm3            #28.3
        pxor      %xmm6, %xmm6                                  #28.3
        movsd     .L_2il0floatpacket.56(%rip), %xmm5            #28.3
        incl      %eax                                          #28.3
        cmpl      %ecx, %eax                                    #28.3
        addsd     %xmm4, %xmm3                                  #28.3
        subsd     %xmm0, %xmm6                                  #28.3
        addsd     %xmm4, %xmm5                                  #28.3
        addsd     %xmm4, %xmm3                                  #28.3
        addsd     %xmm4, %xmm5                                  #28.3
        divsd     %xmm3, %xmm6                                  #28.3
        divsd     %xmm5, %xmm6                                  #28.3
        mulsd     %xmm6, %xmm1                                  #28.3
        jl        ..B1.7        # Prob 82%                      #28.3
                                # LOE rbx r12 r14 r15 eax edx ecx xmm0 xmm1 xmm2 xmm7
..B1.8:                         # Preds ..B1.7
        movsd     %xmm7, 8(%rsp)                                #
        testl     %ecx, %ecx                                    #28.3
                                # LOE rbx r12 r14 r15 edx ecx xmm2
..B1.9:                         # Preds ..B1.8 ..B1.5
        jle       ..B1.13       # Prob 10%                      #28.3
                                # LOE rbx r12 r14 r15 edx ecx xmm2
..B1.10:                        # Preds ..B1.9
        movaps    %xmm2, %xmm0                                  #28.3
        mulsd     %xmm2, %xmm0                                  #28.3
        movsd     16(%rsp), %xmm6                               #28.3
        .align    16,0x90
                                # LOE rbx r12 r14 r15 edx ecx xmm0 xmm2 xmm6
..B1.11:                        # Preds ..B1.11 ..B1.10
        pxor      %xmm3, %xmm3                                  #28.3
        addsd     %xmm2, %xmm6                                  #28.3
        cvtsi2sd  %edx, %xmm3                                   #28.3
        movsd     .L_2il0floatpacket.55(%rip), %xmm1            #28.3
        pxor      %xmm5, %xmm5                                  #28.3
        movsd     .L_2il0floatpacket.54(%rip), %xmm4            #28.3
        incl      %edx                                          #28.3
        cmpl      %ecx, %edx                                    #28.3
        addsd     %xmm3, %xmm1                                  #28.3
        subsd     %xmm0, %xmm5                                  #28.3
        addsd     %xmm3, %xmm4                                  #28.3
        addsd     %xmm3, %xmm1                                  #28.3
        addsd     %xmm3, %xmm4                                  #28.3
        divsd     %xmm1, %xmm5                                  #28.3
        divsd     %xmm4, %xmm5                                  #28.3
        mulsd     %xmm5, %xmm2                                  #28.3
        jl        ..B1.11       # Prob 82%                      #28.3
                                # LOE rbx r12 r14 r15 edx ecx xmm0 xmm2 xmm6
..B1.12:                        # Preds ..B1.11
        movsd     %xmm6, 16(%rsp)                               #
                                # LOE rbx r12 r14 r15
..B1.13:                        # Preds ..B1.12 ..B1.9
        ...
        movq      -24(%rcx), %r9                                #30.3
        movl      24+_ZSt4cout(%r9), %r8d                       #30.8
        andl      $-261, %r8d                                   #30.8
        orl       $256, %r8d                                    #30.8
        movl      %r8d, 24+_ZSt4cout(%r9)                       #30.8
..___tag_value_main.17:                                         #31.7
...
# parameter 4: %rdx
..B2.1:                         # Preds ..B2.0
..___tag_value__Z6sincosdiRdS_.49:                              #6.51
        xorl      %eax, %eax                                    #9.3
        pxor      %xmm4, %xmm4                                  #7.7
        xorl      %ecx, %ecx                                    #9.3
        movsd     .L_2il0floatpacket.63(%rip), %xmm2            #8.13
...
..B2.3:                         # Preds ..B2.3 ..B2.2
        ...
        movsd     .L_2il0floatpacket.61(%rip), %xmm5            #11.21
        pxor      %xmm8, %xmm8                                  #11.14
        movsd     .L_2il0floatpacket.63(%rip), %xmm7            #11.31
        incl      %eax                                          #9.3
        cmpl      %edi, %eax                                    #9.3
...
..B2.7:                         # Preds ..B2.7 ..B2.6
        ...
        movsd     .L_2il0floatpacket.62(%rip), %xmm2            #16.21
        pxor      %xmm6, %xmm6                                  #16.14
        movsd     .L_2il0floatpacket.61(%rip), %xmm5            #16.31
        incl      %ecx                                          #14.3
        cmpl      %edi, %ecx                                    #14.3
...
..B2.11:                        # Preds ..B2.1                  # Infreq
        ...
        .align    16,0x90
..___tag_value__Z6sincosdiRdS_.51:                              #
                                # LOE rdx rbx rbp r12 r13 r14 r15 ecx edi xmm0 xmm4
# mark_end;
...
..___tag_value___sti__$E.55:                                    #72.25
...
.eh_frame_seg:
	...
	.8byte ..___tag_value_main.48-..___tag_value_main.1
	.2byte 0x0400
	...
	.4byte 0x0000001c
	.4byte 0x00000074
	.8byte ..___tag_value__Z6sincosdiRdS_.49
	.8byte ..___tag_value__Z6sincosdiRdS_.51-..___tag_value__Z6sincosdiRdS_.49
	.8byte 0x0000000000000000
	.4byte 0x00000024
	.4byte 0x00000094
	.8byte ..___tag_value___sti__$E.52
	.8byte ..___tag_value___sti__$E.60-..___tag_value___sti__$E.52
	.2byte 0x0400
	.4byte ..___tag_value___sti__$E.54-..___tag_value___sti__$E.52
	.2byte 0x100e
	.byte 0x04
	.4byte ..___tag_value___sti__$E.59-..___tag_value___sti__$E.54
	.2byte 0x080e
	.byte 0x00
# End
